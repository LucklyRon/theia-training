...
- go to the exercise's branch - https://github.com/LucklyRon/theia-training/tree/exercise-0
- prefix it with `gitpod.io#` - [https://gitpod.io#https://github.com/LucklyRon/theia-training/tree/exercise-0](https://gitpod.io/#https://github.com/LucklyRon/theia-training/tree/exercise-0)

### [Exercise 0: Build Theia Application](https://github.com/LucklyRon/theia-training/blob/exercise-0/EXERCISE.md#exercise-0-build-theia-application)
...
### [Exercise 1: Implement Quick File](https://github.com/LucklyRon/theia-training/tree/exercise-1#exercise-1-implement-quick-file)
...
### [Exercise 2: Implement File List View](https://github.com/LucklyRon/theia-training/tree/exercise-2#exercise-2-implement-file-list-view)
...
### [Exercise 3: Implement File List View JSON-RPC Service](https://github.com/LucklyRon/theia-training/tree/exercise-3#exercise-3-implement-file-list-view-json-rpc-service)
...
### [Exercise 4: Implement JSON-Form Widget Open Handler](https://github.com/LucklyRon/theia-training/tree/exercise-4#exercise-4-implement-json-form-widget-open-handler)
...
### [Exercise 5: Implement a Language Server](https://github.com/LucklyRon/theia-training/tree/exercise-5#exercise-5-implement-a-language-server)
...
### [Exercise 6: Style and white-label Theia application](https://github.com/LucklyRon/theia-training/tree/exercise-6#exercise-6-style-and-white-label-theia-application)
